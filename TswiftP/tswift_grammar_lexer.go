...
const (
	...
	Tswift_GrammarLexerASIG     = 3
	Tswift_GrammarLexerDIV      = 4
	Tswift_GrammarLexerINT      = 5
	Tswift_GrammarLexerCONSOLE  = 6
	Tswift_GrammarLexerENBLANCO = 7
	Tswift_GrammarLexerENTERO   = 8
	Tswift_GrammarLexerDECIMAL  = 9
	Tswift_GrammarLexerID       = 10
	Tswift_GrammarLexerRETURN   = 11
	Tswift_GrammarLexerUL_C     = 12
)
